...
-- Database: `orgreview`
--
CREATE DATABASE IF NOT EXISTS `orgreview` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `orgreview`;
...
INSERT INTO `organization` (`org_id`, `name`, `description`, `logo`) VALUES
...
INSERT INTO `user` (`user_id`, `fname`, `lname`, `username`, `email`, `password`, `verification`) VALUES
...
--
ALTER TABLE `organization`
  MODIFY `org_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `review`
  ...
  ADD CONSTRAINT `review_ibfk_2` FOREIGN KEY (`org_id`) REFERENCES `organization` (`org_id`);

--
-- Constraints for table `vote`
--
ALTER TABLE `vote`
  ADD CONSTRAINT `vote_ibfk_1` FOREIGN KEY (`org_id`) REFERENCES `organization` (`org_id`),
